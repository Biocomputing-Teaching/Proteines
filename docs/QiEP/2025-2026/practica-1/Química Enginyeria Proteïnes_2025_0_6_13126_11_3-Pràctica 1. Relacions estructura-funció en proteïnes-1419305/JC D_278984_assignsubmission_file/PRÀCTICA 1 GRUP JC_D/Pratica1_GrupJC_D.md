...
![Figura 1. Vista general de l’estructura corresponent al PDB 9CCE (cadena A), representada en mode cartoon i acolorida per cadena.](Figura 1.png)![](Figura 2.png)
**Figura 1.** Imatges de PDB 9CCE (cadena A)
![Figura 2. Representació de l’estructura secundària del fragment, acolorida segons el tipus d’estructura (hèlix alfa, làmina beta i loops), on s’observa una clara predominança de regions desordenades.](Figura 2.png)
**Figura 2.** Imatge de l'estructura secundària.


### Estructures supersecundàries

![Figura 3. Representació del fragment proteic utilitzada per a l’anàlisi de motius supersecundaris, on no s’identifiquen motius estructurals definits a causa de la mida reduïda i la simplicitat de l’estructura.](Figura 3.png)
...
![Figura 4. Representació de la superfície molecular del fragment analitzat, en la qual no s’observa un plegament globular ni la presència de dominis estructurals definits](Figura 4.png)
